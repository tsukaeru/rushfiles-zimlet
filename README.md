...
Tests live in ./tests folder. To make Controller tests work you need to fill in an actual username and password in class name.w.RushFiles.Tests.ControllerTest.

API testing implemented by mock, Controller testing - by real requests. We can treat API tests as unit-testing, Controller tests - as functional-testing. I do not see the point in long-running testing via requests the same functional twice.
